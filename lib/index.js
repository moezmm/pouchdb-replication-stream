...
exports.plugin.load = utils.toPromise(function (readableStream, opts, callback) {
    ...
    readableStream
        ...
        .pipe(through(function (data, _, next) {
            ...
            //Convert attachements (dataURL) to blobs
            //We assume that _attachments[i] is the attachement referenced by attachment[i]
                ...
                if ((null !== doc.attachments) && doc._attachments) {
                    Object.keys(doc.attachments).forEach(function (attachment, index) {
                        if (doc._attachments[Object.keys(doc._attachments)[index]].data) {
                            doc._attachments[Object.keys(doc._attachments)[index]].data = dataURLtoBlob(doc._attachments[Object.keys(doc._attachments)[index]].data);
                        }
                    })
                }
            });
